...
Calibrate::Calibrate(float calibSquareDimension, cv::Size chessboardDimension, cv::Size ir_img, cv::Size hd_img) {
...
void Calibrate::getIntrinsics(bool is_hd) {
...
void Calibrate::getChessboardCorners() {
...
double Calibrate::projectPoints() {
...
int Calibrate::getChessboardCorners(cv::Mat& image, bool is_hd, bool save_images) {
...
int Calibrate::getChessboardCorners(cv::Mat& image_1, cv::Mat& image_2, bool save_images) {
...
int main(int argc, char** argv) {
    ...
    Calibrate calib(0.03, chessboard_dimension, ir_img, hd_img);
